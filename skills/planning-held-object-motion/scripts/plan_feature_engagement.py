...
def run(
    ...
    if relation == "loop_over_shaft":
        # The engaged pose is on the mount side of the shaft tip. It is a
        ...
        waypoints.append(
            {"pose": engaged_pose, "mode": "planned_linear", "allow_goal_contact": True}
        )
        waypoints.append({"pose": mate_pose, "mode": "planned_linear", "allow_goal_contact": True})
    return {
        "placement_plan": {
            "relation": relation,
            "waypoints": waypoints,
