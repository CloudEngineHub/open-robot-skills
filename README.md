...
[![Skills](https://img.shields.io/badge/skills-28-blue.svg)](#skills--what-the-robot-can-do)
...
|---|---|---|---|
| [anchoring-a-free-end](skills/anchoring-a-free-end/) | Pins one end of a cable with the support hand before any crossing is attempted — asks the support-hand planner for the anchor grasp as joint-space legs, refuses it when its worst IK error is past the limit, streams the legs, closes the jaws to the plan's own width and dwells for the fingers' travel, and carries the solved chain and grasp orientation out on the exit so later pay-outs seed from them. | — | `open-robot-skills[anchoring-a-free-end]` |
| [computing-feature-mating-poses](skills/computing-feature-mating-poses/) | Compute desired approach and mate geometry from held and fixture features, resolving free mate symmetries from the current robot pose without executing motion. | — | `open-robot-skills[computing-feature-mating-poses]` |
| [executing-feature-mating](skills/executing-feature-mating/) | Execute a supplied feature-mating motion plan for an already-held rigid object, then release and retract. | — | `open-robot-skills[executing-feature-mating]` |
| [executing-held-object-motion](skills/executing-held-object-motion/) | Execute an ordered, collision-aware pose sequence for an already-grasped rigid object without releasing it. | — | `open-robot-skills[executing-held-object-motion]` |
...
| [perceiving-functional-features](skills/perceiving-functional-features/) | Locate a language-described functional part of a segmented rigid object or fixture and fit a typed loop, shaft, tip, aperture, surface, or region feature. | — | `open-robot-skills[perceiving-functional-features]` |
...
| [perceiving-sorting-pairs](skills/perceiving-sorting-pairs/) | Discovers a labelled four-compartment destination from RGB-D and repeatedly perceives one remaining source object with its matching metric destination region. | — | `open-robot-skills[perceiving-sorting-pairs]` |
...
| [registering-held-objects](skills/registering-held-objects/) | Reobserve a grasped rigid object, estimate its functional feature in the TCP frame, and construct attached collision geometry. | — | `open-robot-skills[registering-held-objects]` |
